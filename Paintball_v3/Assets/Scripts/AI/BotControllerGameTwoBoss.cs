...
public class BotControllerGameTwoBoss : MonoBehaviour
{
    ...
    private BotEnemyDetectionGameTwoBoss _botEnemyDetection;
    ...
    private void Start()
    {
        ...
        _botEnemyDetection = GetComponent<BotEnemyDetectionGameTwoBoss>();
